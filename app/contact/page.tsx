    ...
    <div className="min-h-screen bg-[#F7FAFC]">
        ...
        <div className="container mx-auto px-4 md:px-6 py-3 md:py-4">
          ...
          {showMobileMenu && (
            <nav className="md:hidden border-t border-[#E5EAF0] pt-4 pb-2 mt-3 flex flex-col gap-1">
              ...
              <Link href="/contact" onClick={() => setShowMobileMenu(false)} className="px-3 py-2.5 text-[#2CB1A6] font-semibold hover:bg-[#F7FAFC] rounded-lg transition-colors">Contact Us</Link>
              {user ? (
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-16">
        <div className="text-center mb-8 md:mb-12">
          <h1 className="text-3xl md:text-4xl font-bold text-[#0B1F2A] mb-3">Get in Touch</h1>
