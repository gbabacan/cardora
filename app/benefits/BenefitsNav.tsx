...
export default function BenefitsNav({ variant }: Props) {
        ...
        {showMobileMenu && (
          <nav className="md:hidden border-t border-[#E5EAF0] pt-4 pb-2 mt-3 flex flex-col gap-1">
            <Link href="/benefits/personal" onClick={() => setShowMobileMenu(false)}
              className={`px-3 py-2.5 font-semibold rounded-lg transition-colors ${variant === "personal" ? "text-[#2CB1A6] hover:bg-[#F7FAFC]" : "text-[#5B6B75] hover:text-[#2CB1A6] hover:bg-[#F7FAFC]"}`}>
              Features — Personal
            </Link>
            <Link href="/benefits/corporate" onClick={() => setShowMobileMenu(false)}
              className={`px-3 py-2.5 font-semibold rounded-lg transition-colors ${variant === "corporate" ? "text-[#2CB1A6] hover:bg-[#F7FAFC]" : "text-[#5B6B75] hover:text-[#2CB1A6] hover:bg-[#F7FAFC]"}`}>
              Features — Corporate
            </Link>
