    ...
    <div className="min-h-screen bg-[#F7FAFC]">
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-12">
        ...
        <div className="mb-8 md:mb-10">
          <h1 className="text-3xl md:text-4xl font-bold text-[#0B1F2A] mb-3">Templates</h1>
          <div className="flex flex-col gap-4">
            <p className="text-base md:text-lg text-[#5B6B75]">Choose from our pre-designed templates to get started quickly</p>
