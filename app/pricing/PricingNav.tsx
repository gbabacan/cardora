      ...
      <div className="container mx-auto px-4 md:px-6 py-3 md:py-4">
        ...
        {showMobileMenu && (
          <nav className="md:hidden border-t border-[#E5EAF0] pt-4 pb-2 mt-3 flex flex-col gap-1">
            ...
            <Link href="/pricing" onClick={() => setShowMobileMenu(false)} className="px-3 py-2.5 text-[#2CB1A6] font-semibold hover:bg-[#F7FAFC] rounded-lg transition-colors">Pricing</Link>
